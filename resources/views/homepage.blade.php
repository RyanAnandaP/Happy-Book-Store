@extends('navbar')
{{--homepage--}}
@section('title','Happy Book Store - Ryan Ananda')
...
<div class="d-block bg-primary" style="margin-top: 35px">
    <h2 class="booklist-title" style="background-color: #979A9A ; color:white;font-size:55px;font-family:sans-serif;" id="bookListtxt">Book List</h2>
</div>
@foreach ($books as $x )

<div class="card d-inline-block" style="width: 300px; box-shadow:5px 5px 10px black;margin-right:10px; margin-left:55px">
    <img src="{{$x->image}}" class="card-img-top" alt="Ini adalah gambar kartu">
    <div class="card-body">
